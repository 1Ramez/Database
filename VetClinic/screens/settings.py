...
from services.settings_store import AppSettings, load_settings, save_settings, GEMINI_MODEL, FALLBACK_GEMINI_MODEL
...
class SettingsScreen(tk.Frame):
    ...
    def _build_ui(self):
        ...
        tk.Label(form, text="Model (locked)", bg=t.BG_CARD, fg=t.TEXT_PRIMARY, font=("Segoe UI", 11, "bold")).pack(
            anchor="w"
        )
        tk.Label(
            form,
        ...
        tk.Label(
            form,
            text="The AI chat uses a fixed model and cannot be changed from the UI.",
            bg=t.BG_CARD,
            fg=t.TEXT_MUTED,
            font=t.FONT_SMALL,
            wraplength=560,
    ...
    def _test_key(self):
        ...
        def work():
            try:
                ...
                self.after(0, lambda: self._test_done(full, success=False))
